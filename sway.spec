...
%prep
%setup -q -n sway-1.7
cd %{_builddir}/sway-1.7
pushd ..
cp -a sway-1.7 buildavx2
popd
...
cp %{_builddir}/sway-1.7/LICENSE %{buildroot}/usr/share/package-licenses/sway/7dfd46ff6b01e0649f270341bfb06d662a4f9ee9
