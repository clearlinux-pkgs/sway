...
Version  : 1.6.1
Release  : 7
URL      : https://github.com/swaywm/sway/archive/1.6.1/sway-1.6.1.tar.gz
Source0  : https://github.com/swaywm/sway/archive/1.6.1/sway-1.6.1.tar.gz
...
%prep
%setup -q -n sway-1.6.1
cd %{_builddir}/sway-1.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624636664
...
cp %{_builddir}/sway-1.6.1/LICENSE %{buildroot}/usr/share/package-licenses/sway/7dfd46ff6b01e0649f270341bfb06d662a4f9ee9
cp %{_builddir}/sway-1.6.1/assets/LICENSE %{buildroot}/usr/share/package-licenses/sway/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
