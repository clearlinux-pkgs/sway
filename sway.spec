...
Version  : 1.8
Release  : 16
URL      : https://github.com/swaywm/sway/archive/1.8/sway-1.8.tar.gz
Source0  : https://github.com/swaywm/sway/archive/1.8/sway-1.8.tar.gz
...
%package filemap
Summary: filemap components for the sway package.
Group: Default

%description filemap
filemap components for the sway package.
...
%prep
%setup -q -n sway-1.8
cd %{_builddir}/sway-1.8
pushd ..
cp -a sway-1.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672157760
...
%files filemap
%defattr(-,root,root,-)
/usr/share/clear/filemap/filemap-sway
