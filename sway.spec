...
Version  : 1.10.1
Release  : 42
URL      : https://github.com/swaywm/sway/archive/1.10.1/sway-1.10.1.tar.gz
Source0  : https://github.com/swaywm/sway/archive/1.10.1/sway-1.10.1.tar.gz
...
%prep
%setup -q -n sway-1.10.1
cd %{_builddir}/sway-1.10.1
pushd ..
cp -a sway-1.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737993788
